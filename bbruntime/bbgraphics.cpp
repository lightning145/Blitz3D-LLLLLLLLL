...
void gxText_SetFont(int fii)
{

}

void gxText_Text(int x, int y, const char* text)
{

}

int gxText_StringWidth(const char* text)
{
    return 0;
}

int gxText_StringHeight(const char* text)
{
    return 0;
}

void gxText_FreeFont()
{
...
void bbGraphics(int w, int h, int mode)
{
    Window_Create(w,h,mode);
}
...
*/
void bbText(int x, int y, const char* str)
{
    gxText_Text(x,y,str);
}
...
{
    return gxText_StringWidth(str);
}

int bbStringHeight(const char* str)
{
    return gxText_StringHeight(str);
}
...
void graphics_link(void (*rtSym)(const char* sym, void* pc))
{
    ...
    //display mode
    rtSym("Graphics%width%height%mode=1", bbGraphics);
    ...
    rtSym("Cls%r%g%b", bbCls);
    rtSym("Present",bbPresent);
